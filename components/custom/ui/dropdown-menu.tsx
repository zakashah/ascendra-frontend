...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        'ring-inset focus:bg-[var(--color-gray-100)] focus:ring-1 focus:ring-[var(--color-gray-200)] dark:focus:ring-black/12 data-disabled:cursor-not-allowed dark:focus:bg-[var(--color-gray-1300)]',
