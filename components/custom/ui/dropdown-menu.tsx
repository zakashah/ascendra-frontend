...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        'ring-inset focus:bg-[#F6F6F7] focus:ring-1 focus:ring-[#EBEBED] dark:focus:ring-black/12 data-disabled:cursor-not-allowed dark:focus:bg-[#232328] dark:focus:ring-black/12',
